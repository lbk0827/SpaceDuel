...
export const meta = [
  ...
  { key: 'itemsEnabled',      label: '아이템 배달선',           type: 'bool' },
  { key: 'itemShipInterval',  label: '배달선 간격(s)',          min: 3,   max: 40,   step: 1 },
  { key: 'itemsPerPass',      label: '한 번에 투하 개수',        min: 1,   max: 4,    step: 1 },
  { key: 'itemShipSpeed',     label: '배달선 속도',             min: 2,   max: 20,   step: 0.5 },
  { key: 'itemLifetime',      label: '아이템 수명(s, 0=영구)',   min: 0,   max: 60,   step: 1 },
  { key: 'itemSpdStep',       label: '속도 아이템 증가율',       min: 0.1, max: 1,    step: 0.05 },
